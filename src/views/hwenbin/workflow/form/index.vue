<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px"
              v-if="hasPermission('workflow:form:query')">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-if="hasPermission('workflow:form:add')"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-if="hasPermission('workflow:form:update')"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-if="hasPermission('workflow:form:delete')"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
export default {
  ...
  methods: {
    ...
    handleDetail(row) {
      ...
      console.log('表单content = ', JSON.parse(row.content))
    },
    /** 新增按钮操作 */
    handleAdd() {
      // this.reset();
