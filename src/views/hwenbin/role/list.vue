<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-if="hasPermission('manage:role:add')">新增</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="roleList">
      <el-table-column label="角色编号" prop="id" align="center" width="120" />
      <el-table-column label="角色名称" prop="name" :show-overflow-tooltip="true" align="center" width="150" />
      <el-table-column label="角色标识" prop="code" :show-overflow-tooltip="true" align="center" width="150" />
      <el-table-column label="角色类型" prop="type" align="center" width="90">
        <template slot-scope="scope">
          <el-tag :disable-transitions="true" type="danger" v-if="scope.row.type==0">系统内置</el-tag>
          <el-tag :disable-transitions="true" type="primary" v-if="scope.row.type==1">自定义</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getRoleList(this.addDateRange(this.queryParams, [
    ...
    handleMenu(row) {
      ...
      getAllPermissionList().then(response => {
        ...
        // 获取角色拥有的菜单权限
        getRoleRelatedPermissionIds(id).then(response => {
